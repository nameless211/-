...
public enum MsgCode {
    ...
    REGISTER_EXIST_ERROR(MsgUtil.REGISTER_EXIST_ERROR,MsgUtil.REGISTER_EXIST_ERROR_MSG),
    ORDER_OUT_STOCK_ERROR(MsgUtil.ORDER_OUT_STOCK_ERROR,MsgUtil.ORDER_OUT_STOCK_ERROR_MSG),;
