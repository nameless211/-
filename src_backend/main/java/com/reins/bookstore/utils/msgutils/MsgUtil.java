...
public class MsgUtil {
    ...
    public static final int REGISTER_EXIST_ERROR = -102;
    public static final int ORDER_OUT_STOCK_ERROR = -103;
    ...
    public static final String REGISTER_EXIST_ERROR_MSG = "用户名和密码已存在，请重新输入！";

    public static final String ORDER_SUCCESS_MSG = "挂号成功！";
    public static final String ORDER_OUT_STOCK_ERROR_MSG = "该医生该时段已挂满，请重新选择挂号！";
